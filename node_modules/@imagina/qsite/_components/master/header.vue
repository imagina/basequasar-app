    ...
    <q-drawer id="menuMaster" class="no-shadow" v-model="drawer.menu" bordered
      ...
      <div class="text-white">
        ...
        <div v-else style="min-height: 50px">
          ...
          <!--Information-->
          <div class="bg-primary q-pl-md q-pr-sm row items-center justify-between full-width">
            <!--Title-->
            <div class="ellipsis" style="max-width: calc(100% - 50px)">{{projectName}}</div>
            <!--Button close-->
            <q-btn dense round flat unelevated color="white" icon="chevron_left" size="15px"
