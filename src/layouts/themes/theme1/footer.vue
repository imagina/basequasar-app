      ...
      <q-card style="width: 350px">
        ...
        <q-card-section class="row items-center no-wrap q-pa-none">
          <q-list separator class="full-width" v-close-popup>
            ...
            <!--Offline-->
            <q-item clickable v-ripple @click="eventBus.emit('toggleMasterDrawer','offline')" v-if="$getSetting('isite::offline')">
              <q-item-section avatar>
            ...
            <!--Notification action-->
            <q-item clickable v-ripple @click="eventBus.emit('toggleMasterDrawer','notification')" v-if="$getSetting('isite::showGoToSiteButton')">
              <q-item-section avatar>
